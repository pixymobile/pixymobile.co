...
<head>
      ...
      <title>Pixy - Mobile Development | Ekibimiz</title>
        ...
        <!-- page title area end -->
         ...
         <section class="team__area grey-bg-3 pt-120 pb-70 overflow-y-visible p-relative">
            <div class="team__shape">
               <img class="team-dot" src="assets/img/icon/team/home-2/team-dot.png" alt="">
               <img class="team-triangle" src="assets/img/icon/team/home-2/team-triangle.png" alt="">
            </div>
            <div class="container">
               <div class="row align-items-end">
                  <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-8">
                     <div class="section__title-wrapper mb-70 wow fadeInUp" data-wow-delay=".3s">
                        <span class="section__pre-title blue">Ekibimiz</span>
                        <h2 class="section__title section__title-2">Ekibimizle tanışın</h2>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                     <div class="team__item mb-40">
                        <div class="team__thumb w-img p-relative mb-20 fix">
                           <img src="https://media-exp1.licdn.com/dms/image/C4D03AQEJMLG8r65GcQ/profile-displayphoto-shrink_800_800/0/1631608961894?e=1637193600&v=beta&t=fwnv8Kdt0s0mWwHbDZRDBlRk2Y67Qrrcpl9sYt9g25g" alt="">
                        ...
                        <div class="team__content">
                           <h3 class="team__title"><a href="team-details.html">Berat ŞEN</a></h3>
                           <span class="team__position">CEO / Founder - Mobile Developer</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                     <div class="team__item mb-40">
                        ...
                        <div class="team__content">
                           <h3 class="team__title"><a href="team-details.html">Ogün Arca</a></h3>
                           <span class="team__position">Co- Founder | Graphic Designer</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                     <div class="team__item mb-40">
                        ...
                        <div class="team__content">
                           <h3 class="team__title"><a href="team-details.html">Ömer Merter</a></h3>
                           <span class="team__position">Co - Founder / Business Specialist</span>
                        </div>
                     </div>
                  </div>
