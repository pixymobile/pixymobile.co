<footer class="footer__area grey-bg-3 pt-70 p-relative">
         ...
         <div class="footer__top pb-65">
            <div class="container">
               <div class="row">
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                     <div class="footer__widget mb-50">
                        ...
                        <div class="footer__widget-content">
                           <p>Pixy, güçlü uygulamalar yaratır. 
                           Çok amaçlı uygulamalar yaparak kullanıcılara hizmet vermektedir.</p>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-xxl-12 wow fadeInUp" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
                        <div class="footer__copyright-wrapper text-center">
                           <p>Copyright © 2021 All Rights Reserved by <a href="/">Pixy Mobile</a></p>
                        </div>
                     </div>
                  </div>
               </div>
