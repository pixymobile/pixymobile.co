...
<head>
      ...
      <title>Pixy - İletişime Geçin</title>
                        ...
                        <h3>İletişim </h3>
                           <nav aria-label="breadcrumb">
                              <ol class="breadcrumb justify-content-center">
                                 ...
                                 <li class="breadcrumb-item active" aria-current="page">İletişime Geçin</li>
                              </ol>
                           </nav>
                     </div>
                  </div>
                         ...
                         <div class="row">
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                               <div class="contact__info pr-80">
                                  <h3 class="contact__title">İletişimde kalın</h3>
      
                                  <div class="contact__details">
                                     <ul>
                                        <li>
                                           <h4>Adres</h4>
                                           <p>Tevfik İleri Mh. Ağrı Cd. No:6 06145 Pursaklar/Ankara</p>
                                        </li>
                                        <li>
                                           <h4>Eposta Adresi</h4>
                                           <p><a href="https://themepure.net/cdn-cgi/l/email-protection#b9caccc9c9d6cbcddddccad2f9ded4d8d0d597dad6d4"><span class="__cf_email__" data-cfemail="5e2d2b2e2e312c2a3a3b2d351e39333f3732703d3133">info@pixymobile.co</span></a></p>
                                           <p><a href="https://themepure.net/cdn-cgi/l/email-protection#a9c0c7cfc6dbc4c8c0c6c7e9cec4c8c0c587cac6c4"><span class="__cf_email__" data-cfemail="51383f373e233c30383e3f11363c30383d7f323e3c">beratsen@pixymobile.co</span></a></p>
                                        </li>
                                        <li>
                                           <h4>İletişim Numaraları</h4>
                                           <p><a href="tel:+(046)-320-474-458"> 531 886 26 04</a></p>
                                        </li>
                                     </ul>
                                  </div>
                               </div>
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                               <div class="contact__form">
                                  <form action="#">
                                     ...
                                     <input type="subject" placeholder="Konu">
                                     <textarea placeholder="Mesaj"></textarea>
                                     <button type="submit" class="w-btn w-btn-blue-5 w-btn-6 w-btn-14">İletişime Geç</button>
                                  </form>
                               </div>
                            </div>
                         </div>
               ...
               <div class="row g-0">
                  <div class="col-xxl-12">
                     <div class="contact__map wow fadeInUp" data-wow-delay=".3s">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12215.548576013683!2d32.9188072!3d40.0556194!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xb312afe432edf0e7!2zTk4gR3J1cCB8IEFkcmlhIHwgS2FyYXZhbiBTYXTEscWf!5e0!3m2!1str!2str!4v1631199654110!5m2!1str!2str"></iframe>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="row">
                     <div class="col-xxl-12 wow fadeInUp" data-wow-delay=".5s">
                        <div class="footer__copyright-wrapper footer__copyright-wrapper-2 text-center">
                           <p>Copyright © 2021 All Rights Reserved passion by <a href="#">Pixy Mobile</a></p>
                        </div>
                     </div>
                  </div>
               </div>
